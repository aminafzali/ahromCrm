...
//   useEffect(() => {
//     if (!defaultValues?.id) {
//       // فقط اگر فاکتور جدید است (در حالت ویرایش اجرا نشود)
...
//       getNextNumber();
//     }
//   }, [defaultValues, fetchNextInvoiceNumber]);
//   // END - ADDED CODE
...
//       data.name = `فاکتور ${
//         user?.displayName || ""
//       } ${calculateTotal()} شماره ${invoiceNumber}`;
...
//                 type="number"
//                 value={invoiceNumber || ""}
//                 onChange={(e: any) => setInvoiceNumber(Number(e.target.value))}
