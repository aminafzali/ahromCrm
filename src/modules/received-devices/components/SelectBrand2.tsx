...
import { columnsForAdmin } from "../../brands/data/table";
import { BrandRepository } from "../../brands/repo/BrandRepository";
...
const SelectBrand2: React.FC<SelectBrandProps> = ({
  onSelect,
  buttonProps,
  value,
}) => {
  const [isModalOpen, setIsModalOpen] = useState(false);
  //const datab = useBrand();
