...
import { ActivityCategoryWithRelations, ActivityCategoryWithRelations as TreeNodeType } from "../types";

interface CategoryTreeProps {
  data: ActivityCategoryWithRelations[];
  selectedId?: number | null;
  onNodeClick: (node: ActivityCategoryWithRelations) => void;
}
