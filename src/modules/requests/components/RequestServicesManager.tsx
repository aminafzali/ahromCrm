// // مسیر فایل: src/modules/requests/components/RequestServicesManager.tsx
...
//     onClick={onSelect}
//     disabled={isSelected}
//     className={`bg-white dark:bg-slate-800 rounded-xl shadow-md p-4 text-right flex flex-col transition-all duration-300
//       ${
//         isSelected
//           ? "border-2 border-slate-300 opacity-60 cursor-not-allowed"
//           : "border border-slate-200 dark:border-slate-700 hover:shadow-lg hover:border-blue-500 dark:hover:border-blue-500"
//       }`}
//   >
//     <div className="flex justify-between items-start">
//       <h4 className="font-bold text-md text-slate-800 dark:text-white mb-1">
//         {service.name}
//       </h4>
//       {isSelected && (
//         <DIcon icon="fa-check-circle" classCustom="text-xl text-green-500" />
//       )}
//     </div>
//     <p className="text-sm text-slate-500 dark:text-slate-400 flex-grow">
//       {service.description}
//     </p>
//     <p className="text-lg font-extrabold text-blue-600 dark:text-blue-400 mt-3 self-end">
...
//       quantity: 1,
//       price: service.price,
//       // نام سرویس را نیز اضافه می‌کنیم تا در لیست انتخاب شده نمایش دهیم
//       //  name: service.name,
//     });
//   };
...
//   return (
//     <div className="bg-slate-50 dark:bg-slate-900/50 p-4 rounded-xl mt-6">
//       <h3 className="text-lg font-bold text-slate-800 dark:text-white px-2 mb-4">
//         افزودن خدمات به درخواست
//       </h3>

//       {/* بخش لیست خدمات انتخاب شده */}
//       {fields.length > 0 && (
//         <div className="mb-6 p-4 border dark:border-slate-700 rounded-lg bg-white dark:bg-slate-800">
...
//               <div
//                 key={field.id}
//                 className="flex flex-wrap items-center gap-4 p-3 bg-slate-100 dark:bg-slate-700/50 rounded-lg"
//               >
//                 <button
//                   type="button"
...
//                 <div className="flex-grow font-semibold text-slate-800 dark:text-slate-200">
//                   {(field as any).name || "..."}
//                 </div>
...
//                   <Input
//                     type="number"
//                     className={`bg-white dark:bg-slate-800 !w-36`}
...
//                   (s: any) => s.actualServiceId === service.id
//                 )}
//               />
//             ))}
//           </div>
