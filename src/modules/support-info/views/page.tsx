...
import CategoryTree from "@/modules/support-info-categories/components/CategoryTree";
import { useSupportInfoCategory } from "@/modules/support-info-categories/hooks/useSupportCategory";
import { SupportInfoCategoryWithRelations } from "@/modules/support-info-categories/types";
import { useEffect, useMemo, useState } from "react";
import { columnsForAdmin } from "../data/table";
import { SupportInfoRepository } from "../repo/SupportsRepository";

export default function SupportInfoIndexPage() {
  const { getAll, loading } = useSupportInfoCategory();
    ...
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
      ...
      <div className="lg:col-span-3">
        <IndexWrapper
          ...
          repo={new SupportInfoRepository()}
