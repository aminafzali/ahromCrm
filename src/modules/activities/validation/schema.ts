...
export const activitySourceEnum = z.enum(["INBOUND", "OUTBOUND"]);

export const activityTypeEnum = z.enum(["CALL", "TICKET", "MEETING"]);

export const activitySubjectEnum = z.enum([
  "SALES_ORDER",
  "SALES_QUOTE",
  "PURCHASE_ORDER",
  "PURCHASE_QUOTE",
...
export const activityPriorityEnum = z.enum([
  "LOW",
  "MEDIUM",
  "HIGH",
  "CRITICAL",
...
export const createActivitySchema = z.object({
  ...
  subject: activitySubjectEnum,
  priority: activityPriorityEnum.default("MEDIUM"),
