...
export const createTaskSchema = z.object({
  ...
  globalStatus: z.object({ id: z.number() }),
  projectStatus: z.object({ id: z.number() }).optional(),
...
export const updateTaskSchema = z.object({
  ...
  globalStatusId: z.number().optional(),
  projectStatusId: z.number().optional().nullable(),
  globalStatus: z.object({ id: z.number() }).optional(),
  projectStatus: z.object({ id: z.number() }).optional(),
  projectId: z.number().optional(),
  orderInStatus: z.number().optional().nullable(), // <<<<<<< این خط را اضافه کن
  projectOrderInStatus: z.number().optional().nullable(),
  assignedUsers: z.array(z.object({ id: z.number() })).optional(),
